...
import { NeonGradientCard } from "./magicui/NeonGradientCard };.tsx";
const About = () => {
  ...
  return (
    ...
    <Particles
      ...
      <div className="bs:ml-10 bs:w-3/5 flex flex-col lg-mx:gap-3  bs-mx:items-center">
        ...
        <div className="text-white text-4xl flex font-semibold lg-mx:text-[27px] sm-mx:text-2xl xs-mx:text-xl xsm-mx:text-lg">I'm a&nbsp; <span className="text-primaryColor"><Typewriter
          options={{
            strings: Info.stack,
            autoStart: true,
            loop: true,
        ...
        <div className="xs-mx:w-[90%] flex gap-3 xs-mx:justify-between">
                        ...
                        <Button component="a" href="Abhi_Resume.pdf" download={Info.name} className="focus-visible:!outline-none !text-primaryColor !w-fit xs-mx:!w-[46%]" size={btn} variant="outline" color="#64FFDA" rightSection={<IconDownload size={20} />}>Download</Button>
                    </div>
      </div>
