...
const FloatingInput = (props: any) => {
  ...
  return <div> <div className="relative">
      ...
      {props.error && <div className="text-red sm-mx:text-sm xs-mx:text-xs  ml-1 mt-1">{props.error}</div>}
  </div>
}
