...
import { Info, socialLinks } from '../User.tsx'
...
const Footer = () => {
  ...
  return (
    <div className="mt-20 mb-10 font-mono flex flex-col gap-2 items-center">
      ...
      <div className="text-textColor text-xl md-mx:text-lg sm-mx:text-base xs-mx:text-sm xs-mx:flex flex-col items-center">Copyright &copy; {new Date().getFullYear()} {Info.name} | All Rights Reserved. </div>
    </div>
  )
}
